...
\end{solution}
    ...
    \begin{solution}
      ...
      % Alternatively, using the universal property, assume that $S_3$ is a coproduct $C_n \coprod C_m$ of cyclic groups. Then the canonical inclusions $C_n \hookrightarrow C_n \ast C_m$ and $C_m \hookrightarrow C_n \ast C_m$ would factor through a unique homomorphism $S_3 \to C_n \ast C_m$. Its image is a subgroup of $C_n \ast C_m$ of order 6, which is cyclic. But $S_3$ is not cyclic, so this is a contradiction.
    \end{solution}
